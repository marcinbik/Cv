export default function () {
    return(
            ...
            <form className="w-[30vw]" action="/send-data-here" method="post">
                ...
                <input type="text" className='class="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 mb-3 leading-tight text-black focus:outline-none focus:shadow-outline"' id="last" name="last" />
                <label className="block text-white text-sm font-bold mb-2" for="email">email</label>
                <input type="text" id="email" name="email" className='class="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-black mb-3 leading-tight focus:outline-none focus:shadow-outline"' />
                <label className="block text-white text-sm font-bold mb-2" for="info">Treść</label>
                <textarea type="text"  id="info" className='class="shadow appearance-none border h-[12vh]  border-red-500 rounded w-full py-2 px-3  text-balck mb-3 leading-tight focus:outline-none focus:shadow-outline"' name="last" />
